...
local lualine_theme = {
    ...
    normal   = {
        a = { fg = palette.base00, bg = palette.base00 }, -- section a (mode): invisible, blends with black bar
        b = { fg = palette.base05, bg = palette.base00 }, -- section b (file): invisible, blends with black bar
        c = { fg = palette.base05, bg = palette.base00 }, -- section c (center): invisible, blends with black bar
        x = { fg = palette.base05, bg = palette.base00 }, -- section x (LSP/diag): invisible, blends with black bar
        y = { fg = palette.base05, bg = palette.base00 }, -- section y (branch+changes): invisible, blends with black bar
        z = { fg = palette.base05, bg = palette.base00 }, -- section z (trailing): invisible, blends with black bar
        -- NOTE: fg = base00 means text is invisible on base00 bg.
        -- If you want readable text on the black bar, change fg to palette.base05 (light text).
    },
    -- MODE-SPECIFIC overrides: only section 'a' (mode) gets a colored bg
    -- Sections b/c/x/y/z use normal mode colors (black bar)
    insert   = { a = { fg = palette.base00, bg = palette.base0D } }, -- mode bg: blue
    visual   = { a = { fg = palette.base00, bg = palette.base0C } }, -- mode bg: cyan/green
    replace  = { a = { fg = palette.base00, bg = palette.base08 } }, -- mode bg: red
    command  = { a = { fg = palette.base00, bg = palette.base0A } }, -- mode bg: yellow
...
require('lualine').setup {
    ...
    sections = {
        ...
        lualine_z = {
            ...
            { "fileformat", color = { fg = palette.base00 }, symbols = { unix = "", dos = "", mac = "" }, },
        },
    },
    inactive_sections = {
        lualine_a = {},
